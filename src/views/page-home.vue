...
<template>
  <app-section title="Главная">
    <p>
      В мире <b>Frontend есть проблема:</b> многие разработчики <b>либо не знают структуры данных, либо не понимают их применение</b>.
    </p>
    <p>
    ...
    <div>
      ...
      <ul>
        <li><a target="_blank" href="https://t.me/anti_pode">Тимофей Соломенников</a></li>
        <li><a target="_blank" href="https://t.me/anotherUselessNickname">Мирзоев Руслан</a></li>
      </ul>
    </div>
  </app-section>
</template>
